---
name: "source-command-claire-loop-init"
description: "One-time idempotent bootstrap of the Claire backlog (labels, milestones, ~41 issues, tracking issue)."
---

# source-command-claire-loop-init

Use this skill when the user asks to run the migrated source command `claire-loop-init`.

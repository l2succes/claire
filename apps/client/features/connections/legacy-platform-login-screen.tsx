/**
 * Legacy platform connection screen.
 *
 * Rollback: point app/(auth)/login.tsx back at this default export.
 *
...
import { PlatformAuthModal } from './legacy-platform-auth-modal';

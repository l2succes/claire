...
- [Payments & AI Credits Spec](docs/PAYMENTS_AND_AI_CREDITS_SPEC.md) — Claire Cloud annual workspace contract, prepaid managed-AI credits, BYOK, ledger, entitlements, and payment controls

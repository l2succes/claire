...
SMTP_PASS=
SMTP_ADMIN_EMAIL=
SMTP_SENDER_NAME=Claire
SMTP_MAX_FREQUENCY=1m

# Public URLs of HTML generated by `bun run emails:build`.
# Leave blank for local development unless the website is running publicly.
...
MAILER_TEMPLATES_REAUTHENTICATION=
MAILER_TEMPLATES_PASSWORD_CHANGED_NOTIFICATION=
MAILER_TEMPLATES_EMAIL_CHANGED_NOTIFICATION=

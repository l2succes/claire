  ...
  return (
    <SafeAreaView style={styles.safeArea} testID="claire-desktop-shell">
      ...
      <View style={styles.appFrame}>
        ...
        {visitedDestinations.has('Promises') ? <WorkspacePane active={destination === 'Promises'}><PromisesPane api={api} onOpenChat={openConversation} onOpenInbox={() => setDestination('Inbox')} /></WorkspacePane> : null}
...
const styles = Object.assign(StyleSheet.create({
  ...
  promisesPane: { flex: 1, minWidth: 0, backgroundColor: colors.cream }, promisesContent: { padding: space[6], maxWidth: 900 }, promiseHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: space[5] }, promiseCard: { backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.neutral[200], borderLeftWidth: 4, borderLeftColor: colors.warning, borderRadius: radius.card, padding: space[4], marginBottom: space[3] }, promiseCardOverdue: { borderLeftColor: colors.danger }, promisePerson: { flexDirection: 'row', alignItems: 'center', columnGap: space[3], marginBottom: space[3] }, promisePersonText: { flex: 1 }, replyLabel: { color: colors.focus }, promiseText: { fontWeight: '600', marginBottom: space[2] }, overdueText: { color: colors.danger },
